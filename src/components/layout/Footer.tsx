        ...
        <div class="footer__col footer__col--contact">
          ...
          <div class="footer__social-wrap">
            ...
            <div class="footer__social-list">
              ...
              {/* Facebook */}
              <a
                href="https://www.facebook.com/growupagencyorg"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                class="footer__social-btn"
              >
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M22 12a10 10 0 10-11.6 9.9v-7H8v-2.9h2.4V9.7c0-2.4 1.4-3.7 3.6-3.7 1 0 2 .1 2 .1v2.3h-1.1c-1.1 0-1.4.7-1.4 1.4v1.7H16l-.4 2.9h-2.1v7A10 10 0 0022 12z" />
                </svg>
              </a>

              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/in/aliona-rusu-370072173/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                class="footer__social-btn"
              ...
              >
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M21.9 4.1l-3.3 15.6c-.2 1.1-.9 1.4-1.8.9l-5-3.7-2.4 2.3c-.3.3-.5.5-1 .5l.3-5.2 9.4-8.5c.4-.3-.1-.5-.6-.2L6 12.9l-5-1.6c-1.1-.3-1.1-1.1.2-1.6l19.6-7.6c.9-.3 1.7.2 1.5 1z" />
                </svg>
              </a>

              {/* Pinterest */}
              <a
                href="https://www.pinterest.com/growupagencyorg/"
                target="_blank"
                rel="noopener noreferrer"
