...
const TEXT: Record<Lang, any> = {
  ru: {
    desc:
      'Маркетинг, сайты и визуал для тех, кто хочет расти быстрее конкурентов — без лишней воды и сложностей.',
    nav: 'Навигация',
    home: 'Главная',
    services: 'Услуги',
    projects: 'Кейсы',
  ...
  en: {
    desc:
      'Marketing, websites and visuals for businesses that want to grow faster than competitors — without unnecessary complexity.',
    nav: 'Navigation',
    home: 'Home',
    services: 'Services',
    projects: 'Projects',
  ...
  ro: {
    desc:
      'Marketing, site-uri și vizual pentru afaceri care vor să crească mai rapid decât concurența — fără complicații inutile.',
    nav: 'Navigație',
    home: 'Acasă',
    services: 'Servicii',
    projects: 'Proiecte',
